module.export = function (token, customerApiKey) {
    var getJobByEmployeeIdent = '<s:Envelope xmlns:a="http://www.w3.org/2005/08/addressing" xmlns:s="http://www.w3.org/2003/05/soap-envelope">\n' +
                                    '\t<s:Header>\n' +
